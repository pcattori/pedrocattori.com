---
title: The case for snake_case
description: It's easier to read because it preserves word shapes
publishedAt: 2023-01-30
---

Most languages already have a convention for what case to use. Just use that; an imperfect convention is better than two competing ones.

But if you are in the rare situation where you can choose, pick `snake_case`; it's the best case.

## Ideas need names

Sketches and diagrams only get you so far without names.
...
![gif fading between words and their corresponding word shapes](./word-shapes.gif)
...
![gif fading between prose and snake_cased](./snake-case-preserves-word-shapes.gif)
